            ...
            <div className="flex flex-col w-[56%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col mt-9 max-md:mt-10 max-md:max-w-full">
                ...
                <div className="flex flex-col px-20 mt-16 max-md:px-5 max-md:mt-10 max-md:max-w-full">
                  <div className="flex gap-5 items-center py-2.5 pr-14 pl-5 border-2 border-solid shadow-sm bg-slate-50 border-neutral-300 rounded-[44px] max-md:flex-wrap max-md:pr-5 max-md:mr-1">
                    <img
                      loading="lazy"
                    ...
                    />
                    <div className="flex-auto self-stretch my-auto text-2xl font-medium text-black">
                      +49 30 901820
                    </div>
                    <div className="justify-center self-stretch px-4 py-2 text-2xl text-white bg-blue-500 rounded-[53px] max-md:px-5">
                      Get early access
                    </div>
                  </div>
                </div>
