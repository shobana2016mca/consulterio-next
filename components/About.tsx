            ...
            <div className="lg:pl-[100px] flex items-center">
              <div className="data w-full">
                ...
                <p className="font-normal text-xl leading-8 text-gray-500 max-lg:text-center max-w-2xl mx-auto">
                  ...
                  role that talent plays in the success of any business. That's
                  why our mission is to provide unparalleled recruitment
                  services, delivering the right candidates at the right time
                  and at an affordable price. With a focus on software-based and
                  corporate sectors, our team of experts is dedicated to
                  understanding the unique requirements of each client and
                  sourcing candidates who not only possess the necessary skills
                  but also align with their company culture. Our core value of
                  providing quality recruitment services at an affordable price
                  sets us apart. We offer a competitive fee structure of 8.33%
                  on the annual CTC, ensuring our clients receive exceptional
                  value without compromising on quality. Experience the
                  difference with Consultero. Let us help you build a talented
