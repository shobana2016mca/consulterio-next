...
export default function EnquiryForm() {
 ...
 bg-white font-[sans-serif]'>
      <div>
        <h2 className='text-[#333] text-xl font-semibold'>Enquiry Form</h2>
        <div className='px-4 space-y-10 mt-8'>
          <div className='flex'>
            ...
            <div className='ml-4'>
              ...
              <p className='text-xs'>Chat with our team to help.</p>
              <p className='text-sm font-semibold mt-4'>exmple@gmail.com</p>
            </div>
          </div>
          <div className='flex'>
            <div className='w-8 h-8 flex items-center shrink-0 rounded border p-1.5'>
            ...
            <div className='ml-4'>
              <h4 className='text-[#333] text-base font-semibold'>Visit us</h4>
              <p className='text-xs'>Visit our office HQ.</p>
              <p className='text-sm font-semibold mt-4'>123 Street 256 House</p>
            </div>
          </div>
          <div className='flex'>
            <div className='w-8 h-8 flex items-center shrink-0 rounded border p-1.5'>
            ...
            <div className='ml-4'>
              <h4 className='text-[#333] text-base font-semibold'>Call us</h4>
              <p className='text-xs'>Monday to Friday.</p>
              <p className='text-sm font-semibold mt-4'>+158 996 888</p>
            </div>
          </div>
        </div>
      </div>
