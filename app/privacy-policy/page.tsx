    ...
    <main className={'max-w-6xl mx-auto'}>
      <section className=''>
        <div className='py-8 px-4'>
          ...
          <p className='mb-4'>
            This Privacy Policy describes how Consultero (&quot;we&quot;,
            &quot;our&quot;, or &quot;us&quot;) collects, uses, and protects the
          ...
          <ul className='list-disc list-inside mb-4'>
            <li>
              ...
              when you interact with us or use our services.
            </li>
            <li>
              Usage Information: We may collect information about how you use
              our website or services, including IP addresses, browser type, and
              device identifiers.
            </li>
          </ul>
          ...
          <ul className='list-disc list-inside mb-4'>
            ...
            <li>
              ...
              respond to inquiries, provide updates, or send marketing
              communications.
            </li>
            <li>
              For legal and compliance purposes: We may use your information to
          ...
          <ul className='list-disc list-inside mb-4'>
            ...
            <li>
              You may also have the right to access, update, or delete your
