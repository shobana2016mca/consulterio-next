        ...
        <SectionWrapper>
          <div className='py-8'>
            ...
            <p className='mb-4 text-center'>
              ...
              the personal information you provide when using our website or
              services.
            </p>
            ...
            <ul className='mb-4 list-disc list-inside'>
              ...
              <li>
                ...
                our website or services, including IP addresses, browser type,
            ...
            <ul className='mb-4 list-disc list-inside'>
              ...
              <li>
                For legal and compliance purposes: We may use your information
