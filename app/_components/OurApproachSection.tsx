        ...
        <div className='max-w-5xl px-4 xl:px-0 py-10 lg:pt-20 lg:pb-20 mx-auto'>
          ...
          <div className='max-w-3xl mb-10 lg:mb-14'>
            ...
            <p className='mt-1 text-neutral-400'>
              ...
              approach is key to successful recruitment. Our method is designed
              to ensure that we deliver the best talent to meet your unique
              business needs. Here&apos;s how we do it:
            </p>
          </div>
          {/* <!-- End Title --> */}
