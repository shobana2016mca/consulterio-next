        ...
        <div className='grid gap-4 md:gap-8'>
          <div>
            <p className='mb-8 text-xl'>
              ...
              the services provided by Consultero (&quot;us&quot;,
            ...
            <p className='mb-5'>
              By signing up for our services, you agree to enter into a binding
              agreement with Consultero to receive our recruitment services.
            </p>

            <h2 className='text-lg font-semibold mb-2'>2. Services:</h2>
            <p className='mb-5'>
              We provide recruitment services to help you find suitable
              candidates for your organization. Our services include but are not
              limited to sourcing candidates, scheduling interviews, and
              providing replacement support.
            </p>

            <h2 className='text-lg font-semibold mb-2'>3. Fees:</h2>
            <p className='mb-5'>
              You agree to pay the fees associated with our services as outlined
              in the agreement. Fees may vary depending on the scope of services
              provided.
            </p>

            <h2 className='text-lg font-semibold mb-2'>4. Confidentiality:</h2>
            <p className='mb-5'>
            ...
            <p className='mb-5'>
              ...
              including but not limited to software, logos, and content, belong
              to Consultero. You agree not to use, reproduce, or distribute our
            ...
            <p className='mb-5'>
              We make every effort to provide accurate and reliable services,
              but we cannot guarantee the suitability or performance of
              candidates. We are not liable for any damages, losses, or expenses
            ...
            <p className='mb-5'>
              ...
              the other party breaches these Terms. Upon termination, any
            ...
            <p className='mb-5'>
              ...
              through arbitration in accordance with the rules of [your
            ...
            <p className='mb-5'>
              ...
              Any changes will be effective upon posting on our website. Your
              continued use of our services after the changes constitute
          ...
          <p className='mb-5'>
            By signing up for our services, you acknowledge that you have read,
