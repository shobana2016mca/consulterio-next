...
export const QuoteTemplate = ({ email }: { email: string | string[] }) => (
  <Html>
    <Head />
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={footerCopyright}>
          Copyright © {new Date().getFullYear()} Consultero Inc. <br />{' '}
          <Link href='https://consultero.in/legal/'>All rights reserved</Link>
        </Text>
      </Container>
    </Body>
  </Html>
